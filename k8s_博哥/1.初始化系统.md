https://blog.csdn.net/weixin_46887489/category_12470115.html
https://blog.csdn.net/weixin_46887489/category_12490079.html

sudo -i
apt install vim -y

Ubuntu-22.04 阿里云源及相关注意事宜
...
# ubuntu20.04 resolv.conf 自动还原解决
...
# 作为 k8s 的 node 节点，需要修改 kubelet 的配置解决此 node 节点上 pod 的 DNS 解析问题
...
原文链接：https://blog.csdn.net/weixin_46887489/article/details/133842340
```
...
Input IP address(ip_address): 192.168.73.201
IP address: 192.168.73.201
Input IP address(ip_gateway): 192.168.73.2
IP gateway: 192.168.73.2
