...
*导出离线镜像 docker save xxx > xxx.tar
ctr -n k8s.io images export nginx-1.21.6.tar docker.io/library/nginx:1.21.6 \*导入离线镜像 docker load -i xxx.tar ctr -n k8s.io images import xxx.tar
