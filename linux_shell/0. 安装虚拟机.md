# 这里 没有用老师的 安装和这个脚本初始化虚拟机，我用的是初始化 k8s 系统的那个脚本

https://www.toutiao.com/article/7271254233263964706/
...
http://releases.ubuntu.com/jammy/ubuntu-22.04.3-desktop-amd64.iso # 桌面版 老师用的这个

http://releases.ubuntu.com/jammy/ubuntu-22.04.3-live-server-amd64.iso # 服务器版
